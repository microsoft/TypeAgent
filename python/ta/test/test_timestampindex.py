...
def make_index(ts: list[str]) -> TimestampToTextRangeIndex:
    idx = TimestampToTextRangeIndex()
    # Add as (message_ordinal, timestamp)
    idx.add_timestamps(list(enumerate(ts)))
    return idx
