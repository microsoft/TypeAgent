...
describe("DSL -> Engine integration", () => {
    ...
    describe("literals and constants", () => {
        ...
        it("returns an object literal with mixed refs", async () => {
            const ir = compileOk(`
                workflow pack(name: string, age: integer): any {
    ...
    describe("task calls", () => {
        ...
        it("chains two tasks sequentially", async () => {
            ...
            const ir = compileOk(
                `
                workflow fetchAndFormat(url: string): any {
        ...
        it("accesses a dotted property path", async () => {
            ...
            const ir = compileOk(
                `
                workflow getVal(key: string): any {
    ...
    describe("template literals", () => {
        it("interpolates variables into a template", async () => {
            const ir = compileOk(`
                workflow greet(name: string): any {
    ...
    describe("binary operators", () => {
        it("adds two numbers", async () => {
            const ir = compileOk(`
                workflow add(a: number, b: number): any {
                    const sum = a + b
                    return sum
                }
            `);
        ...
        it("subtracts two numbers", async () => {
            const ir = compileOk(`
                workflow sub(a: number, b: number): any {
                    const diff = a - b
                    return diff
                }
            `);
        ...
        it("multiplies two numbers", async () => {
            const ir = compileOk(`
                workflow mul(a: number, b: number): any {
                    const prod = a * b
                    return prod
                }
            `);
        ...
        it("divides two numbers", async () => {
            const ir = compileOk(`
                workflow div(a: number, b: number): any {
                    const quot = a / b
                    return quot
                }
            `);
        ...
        it("computes modulo", async () => {
            const ir = compileOk(`
                workflow mod(a: number, b: number): any {
                    const rem = a % b
                    return rem
                }
            `);
        ...
        it("compares with ===", async () => {
            const ir = compileOk(`
                workflow eq(a: number, b: number): any {
                    const same = a === b
                    return same
                }
            `);
        ...
        it("compares with !==", async () => {
            const ir = compileOk(`
                workflow neq(a: number, b: number): any {
                    const diff = a !== b
                    return diff
                }
            `);
        ...
        it("compares with > and <", async () => {
            const ir = compileOk(`
                workflow cmp(a: number, b: number): any {
                    const gt = a > b
                    return gt
                }
            `);
        ...
        it("computes boolean && and ||", async () => {
            const irAnd = compileOk(`
                workflow both(a: boolean, b: boolean): any {
                    const r = a && b
                    return r
                }
            `);
            const irOr = compileOk(`
                workflow either(a: boolean, b: boolean): any {
                    const r = a || b
                    return r
                }
            `);
    ...
    describe("branching", () => {
        ...
        it("if/else with continuation after branch", async () => {
            const ir = compileOk(`
                workflow classify(x: number): any {
                    const big = x > 10
                    if (big) {
    ...
    describe("map", () => {
        it("maps over a collection", async () => {
            ...
            const ir = compileOk(
                `
                workflow fetchAll(urls: string[]): any {
        ...
        it("map body can reference outer-scope params", async () => {
            const ir = compileOk(`
                workflow addToAll(items: number[], offset: number): any {
    ...
    describe("filter", () => {
        it("filters a collection by predicate", async () => {
            const ir = compileOk(`
                workflow positives(nums: number[]): any {
        ...
        it("filter body can reference outer-scope params", async () => {
            const ir = compileOk(`
                workflow above(nums: number[], threshold: number): any {
                    const results = filter(nums, (n) => {
    ...
    describe("parallelMap", () => {
        it("maps over a collection in parallel", async () => {
            ...
            const ir = compileOk(
                `
                workflow fetchParallel(urls: string[]): any {
    ...
    describe("composition", () => {
        it("map + filter pipeline", async () => {
            const ir = compileOk(`
                workflow pipeline(nums: number[]): any {
        ...
        it("task call + binary op + ternary", async () => {
            ...
            const ir = compileOk(
                `
                workflow checkPage(url: string, minLen: number): any {
                    const page = web.fetch(url)
                    const ok = minLen > 5
