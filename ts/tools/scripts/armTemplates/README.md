...
- [Speech](https://learn.microsoft.com/en-us/azure/ai-services/speech-service/overview) *(primary region only)*
- [OpenAI](https://learn.microsoft.com/en-us/azure/ai-services/openai/overview)
- [Maps](https://learn.microsoft.com/en-us/azure/azure-maps/about-azure-maps) *(primary region only)*
- [Key Vault](https://learn.microsoft.com/en-us/azure/key-vault/secrets/about-secrets) *(primary region only)*
- [AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/) *(primary region only)*
- [AI Foundry Project](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/create-projects?tabs=ai-foundry&pivots=fdp-project) *(primary region only)*
