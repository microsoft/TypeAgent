...
"find a regression" gate**: the shipped regression predicate — the detector, not
this change — agrees with blind human labels on a fixed benchmark of hand-built
deltas at ~92%, above the 80% bar).
