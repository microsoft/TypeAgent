...
2. **Loop output resolves in body scope, not state.** The IR spec
   ...
   of the final iteration (post-decision 0010: the iteration whose
   `continueWhen` resolves false; pre-0010 the same point was
   named `@exit`). This is correct but initially non-obvious:
