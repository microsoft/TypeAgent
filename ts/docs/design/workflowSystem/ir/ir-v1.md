...
Scenario evidence: [A4 S3](validation/a4-morning-brief.md) (three
independent fetches forced into an arbitrary `next` chain) and
[A4 G1](validation/a4-morning-brief.md) (fan-out over a list, 50x
slower than parallel dispatch). Both are existence proofs, not corner
cases. See also the §1.1.3 tension table row "Forced sequencing."
