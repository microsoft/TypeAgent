...
previously-open knobs the audience lens (§1.1) closed and which one
remains genuinely reviewer-adjustable (constants scoping). Most
closed entries cross-link to a row in this index when they have a
post-v1 reopening condition.
