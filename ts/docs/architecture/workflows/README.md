...
5. **[ir/decisions/](https://github.com/microsoft/TypeAgent/tree/main/ts/docs/architecture/workflows/ir/decisions)** - per-decision records for the IR (one focused doc per significant choice).
6. **[ir/future/](./ir/future/README.md)** - sketches of IR features deferred to future iterations.
