...
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Lives in**     | [`grammar-tools-core`](https://github.com/microsoft/TypeAgent/tree/main/ts/packages/grammarTools/core/src) — `nfaIntersection.ts`, `collisionScanner.ts`                                                                                                                                  | [`agent-dispatcher`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/translation/actionSimilarity.ts) — `actionSimilarity.ts`                                                                                                                    |
...
(`translateRequest` in [translateRequest.ts](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/translation/translateRequest.ts))
with:
...
[actionGrammar README](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/actionGrammar/README.md) and the
...
[`actionGravity.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/neighborhoods/actionGravity.ts).
Available scores:
...
- [`actionSimilarity.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/translation/actionSimilarity.ts) —
  multi-vector embedding similarity scan + clustering
- [`translationProbeRunner.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/translation/translationProbeRunner.ts) —
...
- [`neighborhoods/types.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/neighborhoods/types.ts) —
  `Neighborhood`, `MisrouteEdge`, `PhraseSample` shapes
- [`neighborhoods/merge.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/neighborhoods/merge.ts) —
  pure merge engine (similarity clusters + corpus pairs → neighborhoods)
- [`neighborhoods/previewViz.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/neighborhoods/previewViz.ts) —
  preview HTML renderer (slider + bundling chart + floating phrase panel)

### Command handlers

- [`collisionCommandHandlers.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/context/system/handlers/collisionCommandHandlers.ts) —
  `@collision events / similar / probe / list-strategies`, plus the table
  that wires `corpus` and `neighborhoods` subcommand groups
- [`collisionCorpusHandlers.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/context/system/handlers/collisionCorpusHandlers.ts) —
  every `@collision corpus *` subcommand + the visualize/recovery HTML
  generators
- [`collisionNeighborhoodHandlers.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/context/system/handlers/collisionNeighborhoodHandlers.ts) —
  `@collision neighborhoods preview`

### Operational scripts

- [`packages/defaultAgentProvider/src/collisions/`](https://github.com/microsoft/TypeAgent/tree/main/ts/packages/defaultAgentProvider/src/collisions) —
