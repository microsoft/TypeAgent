...
> [Action Collision Detection section of the dispatcher package README](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/README.md#action-collision-detection)
...
- [ ] **M1. `@config collision <point> [detect|strategy] <value>`** — runtime
      ...
      _Touches:_ [`configCommandHandlers.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/context/system/handlers/configCommandHandlers.ts),
      [`session.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/context/session.ts).
...
- [ ] **M2. Enrich `CollisionEvent` shape.** The existing event captures
      ...
      _Touches:_ [`collisionTelemetry.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/context/collisionTelemetry.ts)
      (type + emit), [`session.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/context/session.ts)
      ...
      [`matchCollision.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/translation/matchCollision.ts),
      [`translateRequest.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/translation/translateRequest.ts),
      [`appAgentManager.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/context/appAgentManager.ts),
      [`fuzzyCollision.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/translation/fuzzyCollision.ts).

- [ ] **M3. Hook `emitCollisionEvent` into the existing telemetry logger.**
      Add one call in
      [`collisionTelemetry.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/context/collisionTelemetry.ts):
...
- [ ] **M5. `@collision events [--limit N] [--kind <point>]`** — read recent
      ...
      [`grammarCommandHandlers.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/context/system/handlers/grammarCommandHandlers.ts)
...
- [ ] **F1.** Real `ActionEmbeddingScorer` — wraps the multi-vector
      ...
      _Touches:_ [`fuzzyCollision.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/translation/fuzzyCollision.ts).
...
- Detection wiring: [`appAgentManager.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/context/appAgentManager.ts),
  [`matchCollision.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/translation/matchCollision.ts),
  [`translateRequest.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/translation/translateRequest.ts),
  [`fuzzyCollision.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/translation/fuzzyCollision.ts)
- Config + persistence: [`session.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/context/session.ts)
- Local telemetry: [`collisionTelemetry.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/context/collisionTelemetry.ts)
- Remote telemetry pipeline:
  [`telemetry/src/logger/cosmosDBLoggerSink.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/telemetry/src/logger/cosmosDBLoggerSink.ts),
  [`telemetry/src/logger/databaseLoggerSink.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/telemetry/src/logger/databaseLoggerSink.ts),
  [`telemetry/src/logger/logger.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/telemetry/src/logger/logger.ts);
  wired in
  [`commandHandlerContext.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/context/commandHandlerContext.ts)
  lines 369–406.
- Existing handlers (M1, M4 patterns): [`configCommandHandlers.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/context/system/handlers/configCommandHandlers.ts)
  (`@config log db` lives at lines 1590–1596),
  [`grammarCommandHandlers.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/src/context/system/handlers/grammarCommandHandlers.ts).
- Tests: [`collisionMatch.spec.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/test/collisionMatch.spec.ts),
  [`collisionFuzzy.spec.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/test/collisionFuzzy.spec.ts),
  [`collisionTelemetry.spec.ts`](https://github.com/microsoft/TypeAgent/blob/main/ts/packages/dispatcher/dispatcher/test/collisionTelemetry.spec.ts),
