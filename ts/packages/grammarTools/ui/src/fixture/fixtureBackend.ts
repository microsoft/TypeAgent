...
const fixtureTrace: MatchTrace = {
    ...
    events: [
        { kind: "ruleEntered", rule: "Start", depth: 0, inputPos: 0 },
        {
            kind: "partAttempted",
            rule: "Start",
            part: 0,
            depth: 0,
            inputPos: 0,
            detail: "part[0] rules <PlayAction>",
        },
        { kind: "ruleEntered", rule: "PlayAction", depth: 1, inputPos: 0 },
        {
            kind: "partAttempted",
            rule: "PlayAction",
            part: 1,
        ...
        },
        {
            ...
            depth: 1,
            inputPos: 5,
            detail: "part[1] rules <ArtistRef>",
        },
        { kind: "ruleEntered", rule: "ArtistRef", depth: 2, inputPos: 5 },
        {
            kind: "partAttempted",
            rule: "ArtistRef",
            part: 3,
    ...
    ] as unknown as MatchTrace["events"],
    result: "matched",
};
