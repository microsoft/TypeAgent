...
export const EXTRACTION_ENVIRONMENTS: Record<
    string,
    ExtractionEnvironmentConfig
> = {
    development: {
        defaultMode: "basic",
        enableAI: false,
...
export class ConfigurationManager {
    ...
    constructor(
        ...
        this.environmentConfig =
            EXTRACTION_ENVIRONMENTS[environment] ||
            EXTRACTION_ENVIRONMENTS.production;
        ...
        console.log(
            `Initialized ConfigurationManager for ${environment} environment`,
        );
    }

    getDefaultMode(
        operation: "index" | "import" | "extract",
