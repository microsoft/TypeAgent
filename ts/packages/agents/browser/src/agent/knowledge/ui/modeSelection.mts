...
export const MODE_CONFIGURATIONS: Record<UnifiedExtractionMode, ModeInfo> = {
    basic: {
        ...
        performance: 'fastest',
        quality: 'basic',
        useCases: ['Bulk imports', 'Fast indexing', 'Low-resource environments'],
        concurrency: 10
    },
    content: {
        mode: 'content',
        ...
        performance: 'fast',
        quality: 'good',
        useCases: ['Quality indexing', 'Content discovery', 'Search optimization'],
        concurrency: 5
    },
    actions: {
        mode: 'actions',
...
export function validateModeSelection(mode: UnifiedExtractionMode, aiModelAvailable: boolean): boolean {
...
export function formatProgressMessage(progress: BatchOperationProgress): string {
