...
export type CloseWindow = {
    ...
    parameters: {
        title?: string; // full title of the active tab in the target window, ignoring surrounding whitespace; matching ignores case by default but can be configured as case-sensitive
    };
};
