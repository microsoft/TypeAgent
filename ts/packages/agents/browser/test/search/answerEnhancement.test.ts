...
import { SmartFollowup, AnswerEnhancement } from "../../src/agent/search/schema/answerEnhancement.mjs";
...
describe("Answer Enhancement - Complete Unified System", () => {
    ...
    describe("Unified AnswerEnhancement Schema", () => {
        test("should validate complete AnswerEnhancement format", () => {
                ...
                followups: [
                    {
                        ...
                        reasoning: "User is interested in AI/ML projects, expanding timeframe would show broader trends",
                        type: "temporal",
                        confidence: 0.88
                    },
                    {
                        query: "Find documentation for these transformer projects",
                        reasoning: "User has transformer repositories, likely needs implementation guides",
                        type: "content",
                        confidence: 0.85
                    },
                    {
                        query: "Compare these language model approaches",
                        reasoning: "User has multiple language model repos, comparison would be valuable",
                        type: "comparative",
                        confidence: 0.82
                    }
                ],
            ...
            expect(Array.isArray(testEnhancement.summary.keyFindings)).toBe(true);
                ...
                followups: [
                    {
                        ...
                        reasoning: "User is interested in TypeScript development",
                        type: "content",
                        confidence: 0.80
                    }
                ],
        ...
        test("should handle empty followups array", () => {
            ...
            expect(Array.isArray(enhancementWithoutFollowups.followups)).toBe(true);
    ...
    describe("Integration Test Scenarios", () => {
        ...
        test("should demonstrate consistency between summary and followups", () => {
                ...
                followups: [
                    {
                        ...
                        reasoning: "User interested in hooks, expand temporal scope for broader learning",
                        type: "temporal",
                        confidence: 0.85
                    },
                    {
                        query: "Find advanced React component patterns and best practices",
                        reasoning: "User has basic tutorials, likely ready for advanced concepts", 
                        type: "content",
                        confidence: 0.83
                    }
                ],
            ...
            expect(followups.every(f => f.query.toLowerCase().includes('react'))).toBe(true);
