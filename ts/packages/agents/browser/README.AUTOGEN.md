...
- **Content Management**: Actions such as `captureScreenshot`, `getHtmlFragments`, and `indexPage` enable users to extract, analyze, and manage web content.
...
_Auto-generated against commit `44b34a9ac8794b6f90489ff7e55fe57283c34960` on `2026-07-11T08:34:41.338Z` by `docs-generate.yml`. Links validated at that commit; the working tree may have drifted by up to 24h. Re-run `pnpm --filter browser-typeagent docs:verify-links` to spot-check._
