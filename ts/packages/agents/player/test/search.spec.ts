...
function fakeTrack(id: string): SpotifyApi.TrackObjectFull {
    return {
        ...
        artists: [{ id: "artist1", name: "Artist", type: "artist", uri: "", external_urls: {}, href: "" }],
        album: {
            id: "album1", name: "Album", type: "album", uri: "", artists: [],
            images: [], album_type: "album", available_markets: [],
            external_urls: {}, href: "", release_date: "2024-01-01",
