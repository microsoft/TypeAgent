...
<!-- AUTOGEN:DOCS:HASH:sha256=b33c2a756d96c72dc68984441c5b7788179f9ce7a6ea538b858449635ddf4419 -->
...
The `typeagent-studio` package is a TypeScript library that powers the TypeAgent developer experience within Visual Studio Code. It provides a comprehensive set of tools for authoring, debugging, and optimizing TypeAgent agents. This package supports workflows such as schema and grammar tuning, compare-and-replay regression detection, trace investigation, and live observation of agent behavior. It is a critical component for developers working with TypeAgent agents, offering an integrated and interactive development environment.

## What it does

The `typeagent-studio` package integrates with Visual Studio Code to provide a rich set of features for managing and debugging TypeAgent agents. These features are accessible through a combination of commands and views, enabling developers to streamline their workflows.

### Commands

The package offers a wide range of commands through the VS Code command palette. These commands are organized into several categories:
...
- **Onboarding and Sandbox Management**:
  ...
  - Sandbox management commands such as `TypeAgent Studio: Start sandbox`, `TypeAgent Studio: Stop sandbox`, and `TypeAgent Studio: Refresh sandboxes` allow developers to manage and interact with sandboxes for testing and debugging.
...
_Auto-generated against commit `fbf54a8aff55bd1ef482ad8fbf2064bc3d38486c` on `2026-07-17T05:44:32.534Z` by `docs-generate.yml`. Links validated at that commit; the working tree may have drifted by up to 24h. Re-run `pnpm --filter typeagent-studio docs:verify-links` to spot-check._
