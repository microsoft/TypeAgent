...
function createQuestionPrompt(question: string): string {
    let prompt: string[] = [
        ...
        "- Return 'NoAnswer' if the question asks for an answer (e.g., the author of a book) that is not explicitly provided in the context.",
        ...
        "- The 'origin' and 'audience' properties only explain the flow of knowledge (sender --> receiver).",
        "- The 'origin' or 'audience' properties' do not equal or imply other roles and facets. E.g. the 'origin' property does not imply 'writer', 'author', 'inventor', etc.",
