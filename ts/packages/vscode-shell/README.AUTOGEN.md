...
# vscode-shell â€” AI-generated documentation
...
- default â†’ `./dist/extension.js` _(not found on disk)_
...
`./src/webview/main.ts`, `./src/agentServerBridge.ts`, `./src/bridge/clientIO.ts`, â€¦and 8 more under `./src/`.
