...
export class WebsiteDocPartMeta extends DocPartMeta {
    ...
    constructor(websiteMeta: WebsiteMeta) {
        ...
        if (websiteMeta.visitDate !== undefined) this.visitDate = websiteMeta.visitDate;
        if (websiteMeta.bookmarkDate !== undefined) this.bookmarkDate = websiteMeta.bookmarkDate;
        this.websiteSource = websiteMeta.websiteSource;
        if (websiteMeta.folder !== undefined) this.folder = websiteMeta.folder;
        if (websiteMeta.pageType !== undefined) this.pageType = websiteMeta.pageType;
        if (websiteMeta.keywords !== undefined) this.keywords = websiteMeta.keywords;
        if (websiteMeta.description !== undefined) this.description = websiteMeta.description;
        if (websiteMeta.favicon !== undefined) this.favicon = websiteMeta.favicon;
        if (websiteMeta.visitCount !== undefined) this.visitCount = websiteMeta.visitCount;
        if (websiteMeta.lastVisitTime !== undefined) this.lastVisitTime = websiteMeta.lastVisitTime;
        if (websiteMeta.typedCount !== undefined) this.typedCount = websiteMeta.typedCount;
        if (websiteMeta.pageContent !== undefined) this.pageContent = websiteMeta.pageContent;
        if (websiteMeta.metaTags !== undefined) this.metaTags = websiteMeta.metaTags;
        if (websiteMeta.structuredData !== undefined) this.structuredData = websiteMeta.structuredData;
        if (websiteMeta.extractedActions !== undefined) this.extractedActions = websiteMeta.extractedActions;
        if (websiteMeta.contentSummary !== undefined) this.contentSummary = websiteMeta.contentSummary;
        if (websiteMeta.detectedActions !== undefined) this.detectedActions = websiteMeta.detectedActions;
        if (websiteMeta.actionSummary !== undefined) this.actionSummary = websiteMeta.actionSummary;
    }
