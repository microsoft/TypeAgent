...
6. Quantifiers ? * + are SPECIAL characters in patterns:
   - Valid ONLY immediately after ")" or ">" : (<Polite>)?, <Song>?, $(x)?, (a|b)*
   - Bare "?" after a word/string is a PARSE ERROR. Escape literals: what is the time\\?
...
2. ALWAYS use parentheses around groups that should be treated as a unit
3. Optional groups must have parentheses
4. Quantifiers ? * + are SPECIAL — valid ONLY immediately after ")" or ">":
