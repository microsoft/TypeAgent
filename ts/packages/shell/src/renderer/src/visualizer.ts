...
function addEvents(wrapper: HTMLElement, wrapper2: HTMLElement, tidyTree: TidyTree, tangledTree: TangledTree) {
    ...
    api.onUpdateKnowledgeVisualization(
        (
            _,
            data: any,
        ) => {
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    treeConfig.title = (_, n) => { return `${n.ancestors().reverse().map(d => d.data.name).join(".")}` };
    ...
    let data = 
        [
            ...
            [ 
              {id: "2024_09_21_17_11_34_726", parents: ['session1 - knowledge']},
              {id: "2024_09_21_17_08_21_185", parents: ["session1 - knowledge"]},
              {id: "2024_09_21_17_11_31_537", parents: ["session1 - knowledge"]},
            ],
            [
              {id: "topics", parents: ['2024_09_21_17_11_34_726', '2024_09_21_17_08_21_185', "2024_09_21_17_11_31_537"]},
              {id: "entities", parents: ['2024_09_21_17_11_34_726', '2024_09_21_17_08_21_185', "2024_09_21_17_11_31_537"]},
              {id: "actions", parents: ['2024_09_21_17_08_21_185', "2024_09_21_17_11_31_537"]},
            ],
            [
            ...
            [
              {id: "retirement gifts", parents: ["gift", "object", "retirement", "gifts", "personalization"]},
              {id: "manchester united", parents: ["team", "club", "sports", "win", "football", "sports", "match", "result"]},
            ...
            [
              ...
              {id: "score", parents: ["bayern munich", "werder bremen", "jamal musiala", "harry kane", "serge gnabry"]}
            ],
