...
- The released DroidCall grader indexes predictions by action name, so duplicate calls collapse to one prediction. Sixty-seven of the 1,000 evaluated rows and 5 of the 46 multi-action test rows are exposed to this behavior. An executed trace must preserve call identity.
